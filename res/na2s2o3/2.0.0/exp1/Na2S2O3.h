...
class f1{
	public: 
		bool endgame=false;int eastereggt=5;dgncx unf;
		void cl(){system("cls");}
		void homes(){
			
			while(endgame!=1){cl();unf.color(15);
				switch(unf.homet()){
					case '1':fm1();cl();break;
					case '2':f2();cl();break;
					case 'c':f2();
		...
		void debug(){
			...
			unf.SetPos(0,2);unf.color(0xE1);cout<<"调试模式（ZYC搞的）\n按“debug”还获得一个《踩蛋》！";
			unf.color(15);eggcheck(5);
		...
		void f1_1_1(){
			...
			cout<<"┃                 按   重来                     ┃"<<endl;
			cout<<"┖───────────────────────────────────────────────┙"<<endl;
			unf.color(6);unf.SetPos(20,15);cout<<"[R]";
			unf.color(15);ending(0);
			unf.color(15);while(tolower(_getch())!='r'){}
		}
		void f1_2(){
			int a=ri(1,2);
			if(a%2==0){
		...
		void f1_1_3(){
			...
			cout<<"┃                 按   重来                     ┃"<<endl;
			cout<<"┖───────────────────────────────────────────────┙"<<endl;
			unf.color(6);unf.SetPos(20,10);cout<<"[R]";
			unf.color(15);ending(2);
			unf.color(15);while(tolower(_getch())!='r'){}
		}
		void f1_1_2(){
			cl();cout<<"剧情"<<endl;
			...
			cout<<"┃                 按   重来                     ┃"<<endl;
			cout<<"┖───────────────────────────────────────────────┙"<<endl;
			unf.color(6);unf.SetPos(20,12);cout<<"[R]";
			unf.color(15);ending(1);
			unf.color(15);while(tolower(_getch())!='r'){}
		}
		void f1_2_1(){
			cl();cout<<"剧情"<<endl;
		...
		void f1_2_2(){
			...
			cout<<"┃                 按   重来                     ┃"<<endl;
			cout<<"┖───────────────────────────────────────────────┙"<<endl;
			unf.color(6);unf.SetPos(20,11);cout<<"[R]";
			unf.color(15);ending(3);
			unf.color(15);while(tolower(_getch())!='r'){}
		}
		void advancement(int id){
			unf.SetPos(80,2);cout<<"┍──────────────────────────────┐";
			unf.SetPos(80,3);cout<<"┃                              ┃";
			unf.SetPos(80,4);cout<<"┃                              ┃";
			unf.SetPos(80,5);cout<<"└──────────────────────────────┚";
			unf.SetPos(81,3);nowee[id]=1;cout<<"已达成彩蛋:"<<eet()<<"/"<<eastereggt;
			unf.SetPos(82,4);cout<<infoee[id];
			Sleep(500);
		}
		void ending(int id){
			unf.SetPos(80,2);cout<<"┍──────────────────────────────┐";
			...
			unf.SetPos(80,4);cout<<"┃                              ┃";
			unf.SetPos(80,5);cout<<"└──────────────────────────────┚";
			unf.SetPos(81,3);endid[id]=1;cout<<"已达成结尾:"<<endt()<<"/"<<5;
			unf.SetPos(82,4);cout<<endinfo[id];
			Sleep(500);
		}
		void fm1(){
			cl();cout<<"剧情"<<endl;
		...
		void f2(){
			...
			cout<<"按   来返回主菜单";
			unf.color(6);unf.SetPos(2,2);cout<<"[R]";
			unf.color(15);while(tolower(_getch())!='r'){}
		}
		void f3(){
			cl();
			...
			cout<<"  按   回到主菜单"<<endl;
			unf.SetPos(2,2);unf.color(0xE1);cout<<"你居然找到了《更新日志》！";
			unf.color(6);unf.SetPos(4,11);cout<<"[R]";
			unf.color(15);while(tolower(_getch())!='r'){}
		}
}; 
