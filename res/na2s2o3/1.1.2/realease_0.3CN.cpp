...
void debug(){
	...
	SetPos(0,2);color(0xE1);cout<<"You've foune the \"Changelog\" part!\nYou can type \"debug\" to get a easter egg!";
	color(15);eggcheck(5);
...
void f3(){
	...
	"  \n"
	"  Added debug mode.\n"
	"  Na2S2O3 has become a complete game.\n"
	"  Added 0 more easter eggs.\n"
	);
	cout<<"Press     to return to the main menu.";
	SetPos(2,2);color(0xE1);cout<<"You've foune the \"Changelog\" part!";
