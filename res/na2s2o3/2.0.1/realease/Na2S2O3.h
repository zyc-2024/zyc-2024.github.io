...
#include "songs.h"
#include "base64.h"
int C8=108,B7=107,A7s=106,A7=105,G7s=104,G7=103,
...
Q=127,H=254,O=508,OH=762,HQ=381,O2=1016,O3=1524,
O4=2032,E=1000063,HE=1000317;
void RICKROLLing(){
    HMIDIOUT handle;
	...
	int sleep=1000;
    int RR[]={
OH,H1,H2,O,M5,OH,H2,H3,Q,H5,H4,H3,H1,
OH,H1,H2,O,M5,OH,H2,H1,Q,
M5,M5,M6,H1,M6,H1,OH,
H1,H2,O,M5,OH,H2,OH,H3,Q,H5,H4,H3,H1,
OH,H1,H2,O,M5,OH,H2,O3,H1,
H,L6,L7,M1,M1,M2,O,L7,Q,L6,1200,L5,
H,L6,L6,L7,M1,O,L6,H,L5,O,M5,H,M5,M2,Q,M3,O2,M2,
H,L6,L6,L7,M1,L6,M1,O,M2,H,L7,L6,Q,L7,L6,1000,L5,
H,L6,L6,L7,M1,L6,O,L5,H,M2,M2,M2,M3,O2,M2,1000,M1,
H,M2,M3,M1,M2,M2,M2,M3,O,M2,O3,L5,
H,L6,L7,M1,O,L6,H,M2,M3,OH,M2,
Q,L5,L6,M1,L6,HQ,M3,M3,OH,M2,
Q,L5,L6,M1,L6,HQ,M2,M2,M1,Q,L7,H,L6,
Q,L5,L6,M1,L6,O,M1,H,M2,O,L7,Q,L6,O,L5,H,L5,O,M2,O,O2,M1,
Q,L5,L6,M1,L6,HQ,M3,M3,OH,M2,
Q,L5,L6,M1,L6,O,M5,H,L7,HQ,M1,Q,L7,H,L6,
Q,L5,L6,M1,L6,O,M1,H,M2,O,L7,Q,L6,O,L5,H,L5,O,M2,1400,M1,
H,M1,M1,L6,M1,O2,M2,H,L7,L6,Q,L7,L6,1200,L5,
H,L6,L6,L7,M1,L6,OH,L5,H,M5,H,M5,O,M2,H,M3,M2,O,M1,
H,M1,M1,L6,M1,L6,M1,O,M2,H,L7,L6,Q,L7,L6,1200,L5,
H,L6,L6,L7,M1,L6,OH,L5,H,M2,M3,O,M3,OH,M2,
1200,M1,H,M2,M3,O,M2,H,M2,M2,M2,M3,O,M2,1200,L5,
H,L5,L6,L7,M1,O,L6,H,M2,M3,1200,M2,
Q,L5,L6,M1,L6,HQ,M3,M3,OH,M2,
Q,L5,L6,M1,L6,HQ,M2,M2,M1,Q,L7,H,L6,
Q,L5,L6,M1,L6,O,M1,H,M2,O,L7,Q,L6,O,L5,H,L5,O,M2,O,O2,M1,
Q,L5,L6,M1,L6,HQ,M3,M3,OH,M2,
...
HQ,H1,H1,1200,M7,
Q,L5,L6,M1,L6,H,M3,
Q,L5,L6,M1,L6,O,M3,HQ,H1,H1,M7,
Q,L5,L6,M1,L6,H,M3,
Q,L5,L6,M1,L6,O,M3,HQ,H1,H1,M7,
H,M1,M1,L6,M1,O2,M2,H,L7,L6,Q,L7,L6,1200,L5,
H,L6,L6,L7,M1,L6,OH,L5,H,M5,H,M5,O,M2,H,M3,M2,O,M1,
...
Q,L5,L6,M1,L6,O,M1,H,M2,O,L7,Q,L6,O,L5,H,L5,O,M2,1400,M1,
	...
	int hesheng=0;
    for(auto i:RR){
    	if(i>1000000){sleep=i-1000000;continue;}
        if(i>108&&i<10000){sleep=i;continue;}
        if(i==10001){
        	//77 82 89
        	midiOutShortMsg(handle,(volume<<16)+(77<<8)+0x9D);
        	midiOutShortMsg(handle,(volume<<16)+(82<<8)+0x9D);
        	midiOutShortMsg(handle,(volume<<16)+(89<<8)+0x9D);
        	goto pnend;
		}
		if(i==10002){
        	//75 82 87
        	midiOutShortMsg(handle,(volume<<16)+(75<<8)+0x9D);
        	midiOutShortMsg(handle,(volume<<16)+(83<<8)+0x9D);
        	midiOutShortMsg(handle,(volume<<16)+(87<<8)+0x9D);
        	goto pnend;
		}
